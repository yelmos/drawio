 ...
 */
/**
 * darwin flow : remove "arrange, extras"
 */
...
Menus.prototype.init = function()
{
	...
	/** darwin flow clean button "file" */
	this.put('file', new Menu(mxUtils.bind(this, function(menu, parent)
	{
		this.addMenuItems(menu, ['new', 'open', '-', 'save', 'saveAs', '-', 'export'], parent);
	})));
...
Menus.prototype.addPopupMenuSelectionItems = function(menu, cell, evt)
{
	if (this.editorUi.editor.graph.isSelectionEmpty())
	{
		this.addMenuItems(menu, ['-', 'selectVertices', 'selectEdges'], null, evt);
	}
};
