...
Actions.prototype.init = function()
{
	...
	this.addAction('setAsDefaultStyle...', mxUtils.bind(this, function()
	{
		...
		if (cell.type === 'input') 
		{
			ui.showInputPropertiesDialog(cell);
			console.log(cell.type);
		} 
		else if (cell.type === 'layer') 
		{
			console.log(cell.type);
			ui.showLayerPropertiesDialog(cell);
		} 
		else if (cell.type === 'output') 
		{
			console.log(cell.type);
			ui.showOutputPropertiesDialog(cell);
		} 
		else if (cell.type === 'connector') 
		{
			console.log(cell.type);
			ui.showConnectorPropertiesDialog(cell);
		}
	...
	this.addAction('clearDefaultStyle...',  mxUtils.bind(this,function()
	{
		...
		ui.showGlobalPropertiesDialog(cell);
