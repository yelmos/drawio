...
var InputPropertiesDialog = function(ui, cell)
{
	var div = document.createElement('div');
	mxUtils.write(div, 'Input Properties' + ' :');
	...
	layerName.setAttribute('title', mxResources.get('layername'));
	...
	layerNameValue.style.marginLeft = '20px';

	layerName.appendChild(layerNameValue);

	// encoding time
	var encodingTime = document.createElement('div');
	encodingTime.setAttribute('title', mxResources.get('encodingtime'));
	mxUtils.write(encodingTime, mxResources.get('encodingtime') + ' :');
	encodingTime.setAttribute('type', 'text');
	encodingTime.style.marginTop = "6px";
	encodingTime.style.marginBottom = "6px";
	encodingTime.style.width = '100%';
	encodingTime.style.height = '20px';
	encodingTime.style.boxSizing = 'border-box';

	var encodingTimeValue = document.createElement('input');
	encodingTimeValue.setAttribute('placeholder', '0');
	encodingTimeValue.setAttribute('type', 'text');
	encodingTimeValue.style.width = '150px';
	encodingTimeValue.style.height = '20px';
	encodingTimeValue.style.marginLeft = '20px';
	encodingTimeValue.style.boxSizing = 'border-box';
	...
	{	
        ...
        texts.push(encodingTimeValue.value);
...
var LayerPropertiesDialog = function(ui, cell)
{
	var div = document.createElement('div');
	mxUtils.write(div, 'Layer Properties' + ' :');
	var graph = ui.editor.graph;
	var value = graph.getModel().getValue(cell);
	...
	neuronSizeValue.style.marginLeft = '20px';
	...
	neuronTypeSelect.style.marginLeft = '20px';
	var neuronTypeOption1 = document.createElement("option");
	mxUtils.write(neuronTypeOption1, 'IF');
	var neuronTypeOption2 = document.createElement("option");
	mxUtils.write(neuronTypeOption2, 'CLIF');
	...
	leakMode.setAttribute("title", mxResources.get("leakmode"));
	...
	leakModeSelect.style.marginLeft = '20px';
	...
	leakModeSelect.appendChild(leakModeOption2);
	leakMode.appendChild(leakModeSelect);

	// leak value
	var leakValue = document.createElement('div');
	leakValue.setAttribute('title', mxResources.get('leakvalue'));
	...
	resetMode.setAttribute("title", mxResources.get("resetmode"));
	...
	resetModeSelect.style.marginLeft = '20px';
	var resetModeOption1 = document.createElement("option");
	mxUtils.write(resetModeOption1, 0);
	var resetModeOption2 = document.createElement("option");
	mxUtils.write(resetModeOption2, 1);
	...
	vThresholdValue.style.marginLeft = '20px';
...
var OutputPropertiesDialog = function(ui, cell)
{
	var div = document.createElement('div');
	mxUtils.write(div, 'Output Properties' + ' :');
	var graph = ui.editor.graph;
	...
	layerName.setAttribute('title', mxResources.get('output'));
	layerName.setAttribute('type', 'text');
	layerName.style.marginTop = "6px";
	layerName.style.marginBottom = "6px";
	layerName.style.width = '100%';
	...
	var decodingTypeValue = document.createElement('input');
	decodingTypeValue.setAttribute('placeholder', 'spikecounts');
	decodingTypeValue.setAttribute('type', 'text');
	decodingTypeValue.style.width = '150px';
	decodingTypeValue.style.height = '20px';
	decodingTypeValue.style.marginLeft = '20px';
	decodingTypeValue.style.boxSizing = 'border-box';

	decodingType.appendChild(decodingTypeValue);
	...
	targetLayerValue.style.marginLeft = '20px';
	targetLayerValue.style.boxSizing = 'border-box';

	targetLayer.appendChild(targetLayerValue);

	// coding time
	var codingTime = document.createElement('div');
	codingTime.setAttribute('title', mxResources.get('codingtime'));
	mxUtils.write(codingTime, mxResources.get('codingtime') + ' :');
	codingTime.setAttribute('type', 'text');
	codingTime.style.marginTop = "6px";
	codingTime.style.marginBottom = "6px";
	codingTime.style.width = '100%';
	codingTime.style.height = '20px';
	codingTime.style.boxSizing = 'border-box';

	var codingTimeValue = document.createElement('input');
	codingTimeValue.setAttribute('type', 'text');
	codingTimeValue.style.width = '150px';
	codingTimeValue.style.height = '20px';
	codingTimeValue.style.marginLeft = '20px';
	codingTimeValue.style.boxSizing = 'border-box';

	codingTime.appendChild(codingTimeValue);


	div.appendChild(layerName);
	div.appendChild(decodingType);
	div.appendChild(targetLayer);
	div.appendChild(codingTime);
	// newProp.appendChild(nameInput);
	// top.appendChild(newProp);
	// div.appendChild(top);
	names = ['layername', 'decodingtype', 'targetlayer', 'codingtime'];
	var addBtn = mxUtils.button(mxResources.get('addProperty'), function()
	{
		var name = nameInput.value;
	...
	{	
		texts.push(layerNameValue.value);
        texts.push(decodingTypeValue.value);
        texts.push(targetLayerValue.value);
		texts.push(codingTimeValue.value);
		try
		{
			ui.hideDialog.apply(ui, arguments);
...
var ConnectorPropertiesDialog = function(ui, cell)
{
	var div = document.createElement('div');
	mxUtils.write(div, 'Connector Properties' + ' :');
	var graph = ui.editor.graph;
	...
	connectorName.setAttribute('title', mxResources.get('connectorname'));
	...
	synapsesValue.setAttribute('placeholder', '0');
	...
	mxUtils.write(linkTypeOption1, 'full');
	var linkTypeOption2 = document.createElement("option");
	mxUtils.write(linkTypeOption2, 2);
	...
	// top.appendChild(newProp);
	// div.appendChild(top);
	names = ['connectorname', 'synapses', 'linktype'];
	var addBtn = mxUtils.button(mxResources.get('addProperty'), function()
	{
		var name = nameInput.value;
...
var GlobalPropertiesDialog = function(ui, cell)
{
	var div = document.createElement('div');
	mxUtils.write(div, 'Global Properties' + ' :');
	...
	projectName.setAttribute('title', mxResources.get('projectname'));
	...
	projectVersion.setAttribute('title', mxResources.get('version'));
	...
	targetArch.setAttribute('title', mxResources.get('target'));
	...
	// net depth
	var netDepth = document.createElement('div');
	mxUtils.write(netDepth, mxResources.get('netdepth') + ' :');
	netDepth.setAttribute('title', mxResources.get('netdepth'));
	netDepth.setAttribute('type', 'text');
	netDepth.style.marginTop = "6px";
	netDepth.style.marginBottom = "6px";
	netDepth.style.width = '100%';
	netDepth.style.height = '20px';
	netDepth.style.boxSizing = 'border-box';

	var netDepthValue = document.createElement('input');
	netDepthValue.setAttribute('type', 'text');
	netDepthValue.style.width = '150px';
	netDepthValue.style.height = '20px';
	netDepthValue.style.marginLeft = '20px';
	netDepthValue.style.boxSizing = 'border-box';

	netDepth.appendChild(netDepthValue);
	...
	leakSign.setAttribute('title', mxResources.get('leaksign'));
	...
	mxUtils.write(leakSignOption0, '-1');
	var leakSignOption1 = document.createElement("option");
	mxUtils.write(leakSignOption1, '0');
	var leakSignOption2 = document.createElement("option");
	mxUtils.write(leakSignOption2, '1');

	leakSignSelect.appendChild(leakSignOption0);
	leakSignSelect.appendChild(leakSignOption1);
	leakSignSelect.appendChild(leakSignOption2);
	leakSign.appendChild(leakSignSelect);

	div.appendChild(projectName);
	div.appendChild(projectVersion);
	div.appendChild(targetArch);
	div.appendChild(netDepth);
	div.appendChild(delayType);
	div.appendChild(leakSign);

	names = ['label', 'projectname', 'version', 'targetarch', 'netdepth', 'delaytype', 'leaksign'];
	...
	{	
		...
		texts.push(projectNameValue.value);
        texts.push(projectVersionValue.value);
        texts.push(targetArchSelect.options[targetArchSelect.selectedIndex].value);
		texts.push(netDepthValue.value);
		texts.push(delayTypeSelect.options[delayTypeSelect.selectedIndex].value);
		texts.push(leakSignSelect.options[leakSignSelect.selectedIndex].value);
		try
		{
			ui.hideDialog.apply(ui, arguments);
