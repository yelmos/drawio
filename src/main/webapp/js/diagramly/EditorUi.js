...
//		}
	...
	EditorUi.prototype.showInputPropertiesDialog = function(cell)
	{
		var ipd = new InputPropertiesDialog(this, cell);
		this.showDialog(ipd.container, 460, 130, true, true);
		ipd.init();
	};

	EditorUi.prototype.showLayerPropertiesDialog = function(cell)
	{
		var lpd = new LayerPropertiesDialog(this, cell);
		this.showDialog(lpd.container, 460, 270, true, true);
		lpd.init();
	};

	EditorUi.prototype.showOutputPropertiesDialog = function(cell) 
	{
		var opd = new OutputPropertiesDialog(this, cell);
		this.showDialog(opd.container, 460, 170, true, true);
		opd.init();
	};

	EditorUi.prototype.showConnectorPropertiesDialog = function(cell)
	{
		var cpd = new ConnectorPropertiesDialog(this, cell);
		this.showDialog(cpd.container, 460, 130, true, true);
		cpd.init();
	}

	EditorUi.prototype.showGlobalPropertiesDialog = function(cell)
	{
		var gpd = new GlobalPropertiesDialog(this, cell);
		this.showDialog(gpd.container, 460, 250, true, true);
		gpd.init();
	}
	/**
